...
projects =
    ...
    map ("ndmitchell/" ++) (words "cmdargs debug extra filepattern ghcid hexml hlint hoogle js-flot js-jquery neil nsis profiterole safe shake tagsoup weeder record-dot-preprocessor record-hasfield rattle") ++
    ["haskell/filepath"]
